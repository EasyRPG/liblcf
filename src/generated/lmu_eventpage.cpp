...
LCF_STRUCT_FIELDS_BEGIN()
	LCF_STRUCT_TYPED_FIELD(RPG::EventPageCondition, condition, 0),
	LCF_STRUCT_TYPED_FIELD(std::string, character_name, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, character_index, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, character_direction, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, character_pattern, 0),
	LCF_STRUCT_TYPED_FIELD(bool, translucent, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, move_type, 0),
