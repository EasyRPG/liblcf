...
#ifndef LCF_RPG_SAVEEVENTRUNSTATE_H
#define LCF_RPG_SAVEEVENTRUNSTATE_H

// Headers
#include <stdint.h>
#include <vector>
#include "rpg_saveeventrunframe.h"

/**
 * RPG::SaveEventRunState class.
 */
namespace RPG {
	class SaveEventRunState {
	public:
		std::vector<SaveEventRunFrame> stack;
	...
	inline bool operator==(const SaveEventRunState& l, const SaveEventRunState& r) {
