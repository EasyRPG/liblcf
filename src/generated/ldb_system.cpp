...
LCF_STRUCT_FIELDS_BEGIN()
	LCF_STRUCT_TYPED_FIELD(int32_t, ldb_id),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, boat_index),
	LCF_STRUCT_TYPED_FIELD(int32_t, ship_index),
	LCF_STRUCT_TYPED_FIELD(int32_t, airship_index),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, transition_out),
	LCF_STRUCT_TYPED_FIELD(int32_t, transition_in),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_start_fadeout),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_start_fadein),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_end_fadeout),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_end_fadein),
	LCF_STRUCT_TYPED_FIELD(int32_t, message_stretch),
	LCF_STRUCT_TYPED_FIELD(int32_t, font_id),
	LCF_STRUCT_TYPED_FIELD(int32_t, selected_condition),
	LCF_STRUCT_TYPED_FIELD(int32_t, selected_hero),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, battletest_terrain),
	LCF_STRUCT_TYPED_FIELD(int32_t, battletest_formation),
	LCF_STRUCT_TYPED_FIELD(int32_t, battletest_condition),
	LCF_STRUCT_TYPED_FIELD(int32_t, unknown_61),
