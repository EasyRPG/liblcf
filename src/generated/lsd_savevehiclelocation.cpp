...
EASYRPG_STRUCT_FIELDS_BEGIN()
	...
	EASYRPG_STRUCT_TYPED_FIELD(int, prelock_facing),
	EASYRPG_STRUCT_TYPED_FIELD(int, facing),
	...
	EASYRPG_STRUCT_TYPED_FIELD(int, unknown_6a),
	EASYRPG_STRUCT_TYPED_FIELD(int, unknown_6b),
