...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, original_move_route_index, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, remaining_ascent, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, remaining_descent, 0),
	LCF_STRUCT_TYPED_FIELD(std::string, sprite2_name, 0),
	LCF_STRUCT_TYPED_FIELD(int32_t, sprite2_id, 0),
