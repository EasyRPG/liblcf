...
LCF_STRUCT_FIELDS_BEGIN()
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, initial_level),
	LCF_STRUCT_TYPED_FIELD(int32_t, final_level),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, face_index),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, unarmed_animation),
	LCF_STRUCT_TYPED_FIELD(int32_t, class_id),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_x),
	LCF_STRUCT_TYPED_FIELD(int32_t, battle_y),
