...
LCF_STRUCT_FIELDS_BEGIN()
	LCF_STRUCT_TYPED_FIELD(int32_t, party_size),
	LCF_STRUCT_TYPED_FIELD(std::vector<int16_t>, party),
	LCF_STRUCT_TYPED_FIELD(int32_t, items_size),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, timer1_secs),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, timer2_secs),
	...
	LCF_STRUCT_TYPED_FIELD(int32_t, battles),
	LCF_STRUCT_TYPED_FIELD(int32_t, defeats),
	LCF_STRUCT_TYPED_FIELD(int32_t, escapes),
	LCF_STRUCT_TYPED_FIELD(int32_t, victories),
	LCF_STRUCT_TYPED_FIELD(int32_t, turns),
	LCF_STRUCT_TYPED_FIELD(int32_t, steps),
